...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ItemData item1 = new ItemData("wallet", R.drawable.wallet, R.drawable.online);
        ItemData item2 = new ItemData("keys", R.drawable.keys, R.drawable.online);
        ItemData item3 = new ItemData("glasses", R.drawable.glasses, R.drawable.offline);
        ItemData item4 = new ItemData("meds", R.drawable.meds, R.drawable.offline);
